    ...
    <div className="container">
      <div className={`form-container ${isFlipped ? 'flipped' : ''}`}>
        <form className="form signup-form" onSubmit={handleSubmit}>
          ...
          <button className="flip-button" type="button" onClick={() => setIsFlipped(!isFlipped)}>Sign In</button>
        </form>
        <form className="form signin-form" onSubmit={handleSigninSubmit}>
          ...
          <button className="flip-button" type="button" onClick={() => setIsFlipped(!isFlipped)}>Sign Up</button>
        </form>
      </div>
    </div>
  );
